...
class ScreenCase1 extends StatefulWidget {
  const ScreenCase1({Key key}) : super(key: key);
  @override
  _ScreenCase1 createState() => _ScreenCase1();


}
class _ScreenCase1 extends State<ScreenCase1>{
        ...
        Column(
          children: [
            SizedBox(
                ...
                child:
                StreamBuilder(
                    stream: FirebaseFirestore.instance.collection('Books').doc('mathématique').collection('mathematique').snapshots(),
